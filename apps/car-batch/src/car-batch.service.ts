...
import { Car } from 'apps/car-api/src/libs/dto/car/car';
import { Member } from 'apps/car-api/src/libs/dto/member/member';
import { CarStatus } from 'apps/car-api/src/libs/enums/car.enum';
import { MemberStatus, MemberType } from 'apps/car-api/src/libs/enums/member.enum';
